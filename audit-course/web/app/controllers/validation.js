...
const checks = {
  id: check('id')
    .isUUID()
    .withMessage('Id not valid, please go back try again'),
  name: check('name')
    .exists()
  ...
  value: check('value')
    ...
    .isLength(1)
    .withMessage(
      'Choice value is required to be at least 1 characters or number',
    ),
  ...
  username: check('username')
    .exists()
    .withMessage('Do not forget your username')
    .isLength(4)
    .withMessage('make sure your username is at least 4 characters long'),
  password: check('password')
    .exists()
    .withMessage('Do not forget your password')
    .isLength(6)
